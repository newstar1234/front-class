...
function TestComponent (props:Props) {  //! 객체형태로 매개변수를 받아올수있음
    ...
    return ( //! return위치에 HTML 작성해야하니까 map배열 함수로 선언 //! if문, for문은 선언은 불가능 / 선언된 경우는 사용 가능
        <div>
